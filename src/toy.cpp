// https://github.com/llvm/llvm-project/blob/llvmorg-13.0.1/llvm/examples/Kaleidoscope/Chapter8/toy.cpp
#include <algorithm>
#include <cassert>
#include <cctype>
#include <cstdio>
...
static std::unique_ptr<PrototypeAST> ParsePrototype() {
  ...
  return std::make_unique<PrototypeAST>(
      FnName, ArgNames, Kind != 0, BinaryPrecedence);
}
...
static AllocaInst* CreateEntryBlockAlloca(
    Function* TheFunction, StringRef VarName) {
  IRBuilder<> TmpB(
